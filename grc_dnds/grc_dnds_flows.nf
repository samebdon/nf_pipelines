include {filterIncompleteGeneModelsAGAT; getLongestIsoformAGAT; selectProteinsAGAT; selectCDSsAGAT; select_proteins; orthofinder; select_orthogroups; select_msa; concat_orthogroup_topologies; iqtree; get_orthogroup_cds; macsev2; select_comparisons; codeml} from './grc_dnds_tasks.nf'
...
workflow orthofinder_flow_gff{

        take:
         input_tsv // channel: [ val(meta), /path/to/genome, /path/to/gff]
        ...
        main:
         ...
         getLongestIsoformAGAT(filterIncompleteGeneModelsAGAT.out)
         selectProteinsAGAT(getLongestIsoformAGAT.out.join(input_ch.genome))

         // combine denovo and preprocessed protein datasets
         selectProteinsAGAT.out
                .collect( flat:false )
                .map{ it.transpose() }
                .set { selected_prot_ch }
...
workflow grc_dnds_flow_gff {
        ...
        main:
         ...
         selectCDSsAGAT(input_ch.gff.join(input_ch.genome))
